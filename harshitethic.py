...
if aienv == None:
    openai.api_key = "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"
else:
...
if tgenv == None:
    tgkey = "6185723724:AAHEgC90Cr4_woJErwbhTd58oQukTWTSInA"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'essaychackerbot'
username = 'essaychackerbot_bot'
